webpackJsonp([5],Array(293).concat([
/* 293 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__anticipos__ = __webpack_require__(445);
...
var CamposPageModule = /** @class */ (function () {
    ...
    CamposPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__anticipos__["a" /* AnticiposPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__anticipos__["a" /* AnticiposPage */]),
            ],
        })
    ], CamposPageModule);
...
//# sourceMappingURL=anticipos.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AnticiposPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var AnticiposPage = /** @class */ (function () {
    function AnticiposPage(navCtrl, appVersion, navParams, alertCrtl, viewCtrl, ariagroData, localData) {
    ...
    AnticiposPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.localData.getSettings().then(function (data) {
            if (data) {
                ...
                _this.ariagroData.getAnticipos(_this.settings.parametros.url, _this.user.ariagroId, _this.campanya.ariagro)
                    .subscribe(function (data) {
                    _this.cargarAnticipos(data);
                }, function (error) {
    ...
    AnticiposPage.prototype.cargarAnticipos = function (anticipos) {
        anticipos.forEach(function (a) {
            a.fecfactu = __WEBPACK_IMPORTED_MODULE_6_moment__(a.fecfactu).format('DD/MM/YYYY');
            a.baseimpo = __WEBPACK_IMPORTED_MODULE_5_numeral__(a.baseimpo).format('0,0.00');
            a.imporiva = __WEBPACK_IMPORTED_MODULE_5_numeral__(a.imporiva).format('0,0.00');
            a.impreten = __WEBPACK_IMPORTED_MODULE_5_numeral__(a.impreten).format('0,0.00');
            a.totalfac = __WEBPACK_IMPORTED_MODULE_5_numeral__(a.totalfac).format('0,0.00');
            a.lineas.forEach(function (l) {
                l.kilosnet = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.kilosnet).format('0,0');
                l.imporvar = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.imporvar).format('0,0.00');
            });
        });
        this.anticipos = anticipos;
    };
    AnticiposPage.prototype.goHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    AnticiposPage.prototype.showAlert = function (title, subTitle) {
    ...
    AnticiposPage.prototype.goAnticipo = function (anticipo) {
        this.navCtrl.push('AnticiposDetallePage', {
            anticipo: anticipo
        });
    };
    AnticiposPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-anticipos',template:/*ion-inline-start:"C:\PROYECTOS\AriagroApp\src\pages\anticipos\anticipos.html"*/'<ion-header>\n\n  <ion-navbar>\n\n   <ion-title>\n\n      {{version}}\n\n    </ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button icon-only class="myGreen" (click)="goHome()">\n\n        <ion-icon name="home"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-list>\n\n    <ion-item text-wrap no-lines class="greenHeader">\n\n      ANTICIPOS / LIQUIDACIONES\n\n      <br> {{campanya.nomresum}}\n\n    </ion-item>\n\n    <ion-grid>\n\n      <ion-row>\n\n        <ion-col col-4>\n\n          <div class="psb">\n\n            <img src="assets/imgs/anticipos.png">\n\n          </div>\n\n        </ion-col>\n\n        <ion-col col-8 class="justificar">\n\n          Estos son los anticipos y liquidaciones que figuran para la campaña. Seleccione para ver el detalle.\n\n        </ion-col>\n\n      </ion-row>\n\n    </ion-grid>\n\n  </ion-list>\n\n  <ion-list>\n\n    <ion-item *ngFor="let anticipo of anticipos" (click)="goAnticipo(anticipo)" text-wrap>\n\n      <span class="myGreen">{{anticipo.nomtipom}} </span><br>\n\n      {{anticipo.factura}} {{anticipo.fecfactu}} <br>\n\n      Base: {{anticipo.baseimpo}} € IVA: {{anticipo.imporiva}} € <br>\n\n      Retención: {{anticipo.impreten}} € TOTAL: {{anticipo.totalfac}} €\n\n      <ion-icon name="log-in" item-end class="myGreen"></ion-icon>\n\n    </ion-item>\n\n  </ion-list>\n\n</ion-content>\n\n\n\n<ion-footer>\n\n  <ion-toolbar>\n\n    <ion-title>\n\n      <span style="font-size:0.8em;">(c) Ariadna SW 2018</span>\n\n    </ion-title>\n\n  </ion-toolbar>\n\n</ion-footer>'/*ion-inline-end:"C:\PROYECTOS\AriagroApp\src\pages\anticipos\anticipos.html"*/,
        }),
...
//# sourceMappingURL=anticipos.js.map
