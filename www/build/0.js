webpackJsonp([0],Array(305).concat([
/* 305 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mensajes__ = __webpack_require__(457);
...
var MensajesPage = /** @class */ (function () {
    function MensajesPage(navCtrl, appVersion, navParams, alertCrtl, viewCtrl, loadingCtrl, ariagroData, localData) {
    ...
    MensajesPage.prototype.cargarMensajes = function () {
        var _this = this;
    ...
    MensajesPage.prototype.showAlert = function (title, subTitle) {
    ...
    MensajesPage.prototype.goMensajeDetalle = function (mensaje) {
        this.navCtrl.push('MensajesDetallePage', {
            mensaje: mensaje
        });
    };
    MensajesPage.prototype.goHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    MensajesPage.prototype.crearMensaje = function () {
        this.navCtrl.push('MensajesEnviarPage', {});
    };
    MensajesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-mensajes',template:/*ion-inline-start:"C:\PROYECTOS\AriagroApp\src\pages\mensajes\mensajes.html"*/'<ion-header>\n\n  <ion-navbar>\n\n   <ion-title>\n\n      {{version}}\n\n    </ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button icon-only class="myGreen" (click)="goHome()">\n\n        <ion-icon name="home"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-list>\n\n    <ion-item text-wrap no-lines class="greenHeader">\n\n        MENSAJES \n\n      </ion-item>\n\n     \n\n          <ion-item (click)=\'crearMensaje()\' class="justificar" text-wrap no-lines>\n\n              Pulse en cualquier mensaje para ver su detalle. Si desea enviarnos un mensaje haga clic aquí.\n\n          </ion-item>\n\n          <ion-item no-lines>\n\n              <button ion-button outline item-end round icon-left class="myGreen" (click)="crearMensaje()">\n\n                <ion-icon name="mail"></ion-icon>\n\n                Enviar\n\n              </button>\n\n          </ion-item>\n\n        \n\n      <div *ngFor="let mensaje of mensajes" (click)="goMensajeDetalle(mensaje)">\n\n        <ion-item text-wrap *ngIf=\'mensaje.estado == "LEIDO"; else color \'>\n\n            FECHA: {{mensaje.fecha}}\n\n            <br>ASUNTO: {{mensaje.asunto}}\n\n            <ion-icon name="log-in" item-end class="myGreen"></ion-icon>\n\n        </ion-item>\n\n        <ng-template #color>\n\n          <ion-item text-wrap  color="lightTeal" style="border-radius: 25px;">\n\n            FECHA: {{mensaje.fecha}}\n\n            <br>ASUNTO: {{mensaje.asunto}}\n\n            <ion-icon name="log-in" item-end class="myGreen"></ion-icon>\n\n          </ion-item>\n\n        </ng-template>\n\n      </div>\n\n    \n\n  </ion-list>\n\n</ion-content>\n\n\n\n\n\n<ion-footer>\n\n    <ion-toolbar>\n\n      <ion-title>\n\n        <span style="font-size:0.8em;">(c) Ariadna SW 2018</span>\n\n      </ion-title>\n\n    </ion-toolbar>\n\n</ion-footer>\n\n'/*ion-inline-end:"C:\PROYECTOS\AriagroApp\src\pages\mensajes\mensajes.html"*/,
        }),
