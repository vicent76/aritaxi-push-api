webpackJsonp([2],Array(302).concat([
/* 302 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_onesignal__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_app_version__ = __webpack_require__(200);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, navParams, plt, alertCrtl, ariagroData, localData, loadingCtrl, appVersion, oneSignal) {
        ...
        this.localData.getSettings().then(function (data) {
            if (data) {
                ...
                if (_this.settings.user) {
                    _this.nombreUsuario = _this.settings.user.nombre;
                    _this.nombreCampanya = _this.settings.campanya.nomresum;
                    _this.cargarMensajes();
                    if (_this.settings.paramPush && _this.settings.paramPush.appId && _this.settings.paramPush.gcm) {
                        _this.regOneSignal();
                    }
                }
                else {
    ...
    HomePage.prototype.regOneSignal = function () {
        var _this = this;
        this.plt.ready().then(function () {
            try {
                ...
                _this.oneSignal.getIds().then(function (ids) {
                    ...
                    if (_this.settings.user.playerId != ids.userId) {
                    ...
                    if (error.status == 404) {
                        _this.showAlert("AVISO", "Usuario o contrase�a incorrectos");
                    }
                });
    ...
    HomePage.prototype.mostrarAlert = function (jsonData) {
        var _this = this;
        var alert = this.alertCrtl.create({
    ...
    HomePage.prototype.goCampanyas = function () {
        this.navCtrl.push('CampanyasPage');
    };
    HomePage.prototype.goDatos = function () {
        this.navCtrl.push('DatosPage');
    };
    HomePage.prototype.goCampos = function () {
        this.navCtrl.push('CamposPage');
    };
    HomePage.prototype.goAnticipos = function () {
        this.navCtrl.push('AnticiposPage');
    };
    HomePage.prototype.goFacturas = function () {
        this.navCtrl.push('FacturasPage');
    };
    HomePage.prototype.goMensajes = function () {
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* Platform */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_app_version__["a" /* AppVersion */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_onesignal__["a" /* OneSignal */]])
    ], HomePage);
    return HomePage;
}());
