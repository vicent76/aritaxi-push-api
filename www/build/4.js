webpackJsonp([4],Array(289).concat([
/* 289 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__entradas__ = __webpack_require__(441);
...
var EntradasPageModule = /** @class */ (function () {
    ...
    EntradasPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__entradas__["a" /* EntradasPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__entradas__["a" /* EntradasPage */]),
            ],
        })
    ], EntradasPageModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EntradasPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var EntradasPage = /** @class */ (function () {
    function EntradasPage(navCtrl, appVersion, navParams, alertCrtl, viewCtrl, ariagroData, localData, modalCtrl) {
    ...
    EntradasPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.localData.getSettings().then(function (data) {
            if (data) {
                ...
                _this.cargarEntradas(_this.navParams.get('campo'));
            }
            else {
    ...
    EntradasPage.prototype.cargarEntradas = function (campo) {
        var comprobar; // comprueba si al formatear la fecha esta ya ha sido formateada
        campo.entradas.forEach(function (e) {
            comprobar = __WEBPACK_IMPORTED_MODULE_6_moment__(e.fecalbar).format('DD/MM/YYYY');
            if (comprobar != 'Invalid date') {
                e.numcajon = __WEBPACK_IMPORTED_MODULE_5_numeral__(e.numcajon).format('0,0');
                e.kilosnet = __WEBPACK_IMPORTED_MODULE_5_numeral__(e.kilosnet).format('0,0');
                e.fecalbar = __WEBPACK_IMPORTED_MODULE_6_moment__(e.fecalbar).format('DD/MM/YYYY');
            }
        });
        this.campo = campo;
    };
    EntradasPage.prototype.goHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    EntradasPage.prototype.showAlert = function (title, subTitle) {
    ...
    EntradasPage.prototype.openModalCalidadesCampo = function (campo) {
        this.modalCalidadesCampo = this.modalCtrl.create('ModalCalidadesCampoPage', { campo: campo });
        this.modalCalidadesCampo.present();
    };
    EntradasPage.prototype.openModalCalidadesAlbaran = function (entrada) {
...
//# sourceMappingURL=entradas.js.map
