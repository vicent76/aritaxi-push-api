...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__facturas__ = __webpack_require__(451);
...
var FacturasPageModule = /** @class */ (function () {
    ...
    FacturasPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__facturas__["a" /* FacturasPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__facturas__["a" /* FacturasPage */]),
            ],
        })
    ], FacturasPageModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FacturasPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_moment__ = __webpack_require__(311);
...
var FacturasPage = /** @class */ (function () {
    function FacturasPage(navCtrl, appVersion, navParams, alertCrtl, viewCtrl, loadingCtrl, ariagroData, localData) {
        ...
        this.years = [];
        this.facturasTienda = [];
        this.numFacturasTienda = 0;
        this.facturasTelefonia = [];
        this.numFacturasTelefonia = 0;
        this.facturasGasolinera = [];
        this.numFacturasGasolinera = 0;
        this.facturasTratamientos = [];
        this.numFacturasTratamientos = 0;
        this.facturasVarias = [];
        this.numFacturasVarias = 0;
    }
    FacturasPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.localData.getSettings().then(function (data) {
            if (data) {
                ...
                _this.generateYears();
                _this.onYearChange(_this.selectedYear);
            }
            else {
    ...
    FacturasPage.prototype.goHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    FacturasPage.prototype.showAlert = function (title, subTitle) {
    ...
    FacturasPage.prototype.generateYears = function () {
        this.years = [];
    ...
    FacturasPage.prototype.onYearChange = function (year) {
    ...
    FacturasPage.prototype.getFacturasTienda = function () {
        var _this = this;
        this.ariagroData.getFacturasTienda(this.settings.parametros.url, this.user.tiendaId, this.selectedYear)
            .subscribe(function (data) {
            data.forEach(function (f) {
                f.fecfactu = __WEBPACK_IMPORTED_MODULE_6_moment__(f.fecfactu).format('DD/MM/YYYY');
                f.bases = __WEBPACK_IMPORTED_MODULE_5_numeral__(f.bases).format('0,0.00');
                f.cuotas = __WEBPACK_IMPORTED_MODULE_5_numeral__(f.cuotas).format('0,0.00');
                f.totalfac = __WEBPACK_IMPORTED_MODULE_5_numeral__(f.totalfac).format('0,0.00');
                f.lineas.forEach(function (l) {
                    l.cantidad = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.cantidad).format('0,0.00');
                    l.importel = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.importel).format('0,0.00');
                    l.precioar = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.precioar).format('0,0.00');
                });
            });
            _this.facturasTienda = data;
            _this.numFacturasTienda = data.length;
        }, function (error) {
            _this.showAlert("ERROR", JSON.stringify(error, null, 4));
        });
    };
    FacturasPage.prototype.getFacturasTelefonia = function () {
        var _this = this;
        this.ariagroData.getFacturasTelefonia(this.settings.parametros.url, this.user.telefoniaId, this.selectedYear)
            ...
            _this.facturasTelefonia = data;
            _this.numFacturasTelefonia = data.length;
        }, function (error) {
            _this.showAlert("ERROR", JSON.stringify(error, null, 4));
        });
    };
    FacturasPage.prototype.getFacturasGasolinera = function () {
        var _this = this;
        this.ariagroData.getFacturasGasolinera(this.settings.parametros.url, this.user.gasolineraId, this.selectedYear)
            ...
            data.forEach(function (f) {
                ...
                f.totalfac = __WEBPACK_IMPORTED_MODULE_5_numeral__(f.totalfac).format('0,0.00');
                f.lineas.forEach(function (l) {
                    l.fecalbar = __WEBPACK_IMPORTED_MODULE_6_moment__(l.fecalbar).format('DD/MM/YYYY');
                    l.cantidad = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.cantidad).format('0,0.00');
                    l.implinea = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.implinea).format('0,0.00');
                    l.preciove = __WEBPACK_IMPORTED_MODULE_5_numeral__(l.preciove).format('0,0.000');
                });
            });
            _this.facturasGasolinera = data;
            _this.numFacturasGasolinera = data.length;
        }, function (error) {
            _this.showAlert("ERROR", JSON.stringify(error, null, 4));
        });
    };
    FacturasPage.prototype.getFacturasTratamientos = function () {
        var _this = this;
        this.ariagroData.getFacturasTratamientos(this.settings.parametros.url, this.user.tratamientosId, this.selectedYear, this.user.ariagroId, this.campanya.ariagro)
            ...
            _this.facturasTratamientos = data;
            _this.numFacturasTratamientos = data.length;
        }, function (error) {
            _this.showAlert("ERROR", JSON.stringify(error, null, 4));
        });
    };
    FacturasPage.prototype.getFacturasVarias = function () {
        var _this = this;
        this.ariagroData.getFacturasVarias(this.settings.parametros.url, this.campanya.ariagro)
            ...
            _this.facturasVarias = data;
            _this.numFacturasVarias = data.length;
        }, function (error) {
            _this.showAlert("ERROR", JSON.stringify(error, null, 4));
        });
    };
    FacturasPage.prototype.goFacturasTienda = function () {
        this.navCtrl.push('FacturasTiendaPage', {
            facturas: this.facturasTienda
        });
    };
    FacturasPage.prototype.goFacturasTelefonia = function () {
        this.navCtrl.push('FacturasTelefoniaPage', {
            facturas: this.facturasTelefonia
        });
    };
    FacturasPage.prototype.goFacturasGasolinera = function () {
        this.navCtrl.push('FacturasGasolineraPage', {
            facturas: this.facturasGasolinera
        });
    };
    FacturasPage.prototype.goFacturasTratamientos = function () {
        this.navCtrl.push('FacturasTratamientosPage', {
            facturas: this.facturasTratamientos
        });
    };
    FacturasPage.prototype.goFacturasVarias = function () {
